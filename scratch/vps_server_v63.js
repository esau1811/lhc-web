...
function loadKeys() {
    try {
        ...
        console.log('[v63] Keys loaded');
    } catch (e) { console.error('[v63] Key load error:', e.message); }
}
loadKeys();
...
async function handle(req, res) {
    ...
    try {
        ...
        console.log('[v63] Applying ArchiveFix to ' + rpf.originalname);
        try {
            ...
            console.log('[v63] ArchiveFix applied successfully.');
        } catch (afErr) {
            console.error('[v63] ArchiveFix failed:', afErr.message);
...
app.listen(port, '0.0.0.0', () => console.log(`[v63] API Ready on port ${port}`));
