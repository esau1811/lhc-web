...
function loadKeys() {
    try {
        ...
        console.log('[v61] Keys loaded');
    } catch (e) { console.error('[v61] Key load error:', e.message); }
}
loadKeys();
...
app.listen(port, '0.0.0.0', () => console.log(`[v61] API Ready on port ${port}`));
