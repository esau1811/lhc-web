        ...
        <div className="space-y-8">
            ...
            {!fileInfo ? (
              <div
                className={`border-2 border-dashed rounded-2xl p-12 transition-all duration-300 flex flex-col items-center justify-center cursor-pointer ${
                  dragOver ? 'border-red-500 bg-red-500/5' : 'border-white/10 hover:border-white/20 hover:bg-white/5'
                }`}
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl px-4 py-3 font-bold">
                  {detectedWeapon ? (
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-[10px] bg-red-500 text-black px-2 py-0.5 rounded">AUTO</span>
                    </div>
                  ) : (
                    <select 
          ...
          <GlassCard className="p-8">
            ...
            <button
              ...
              disabled={!isReady}
              className={`w-full btn-pill py-4 text-lg ${isReady ? 'btn-red' : 'bg-white/5 text-zinc-600 cursor-not-allowed border border-white/10'}`}
            >
