        ...
        >
          <GlassCard className="p-12 md:p-16 text-center relative overflow-hidden">
            ...
            <div className="mb-8 flex justify-center">
              <div className="w-24 h-24 bg-yellow-500/5 rounded-3xl flex items-center justify-center border border-yellow-500/10 shadow-[0_0_50px_rgba(234,179,8,0.1)]">
                <Monitor size={48} className="text-yellow-500" />
              </div>
            </div>

            <h1 className="text-4xl md:text-6xl font-black mb-4 tracking-tighter uppercase">
              LHC<span className="text-yellow-500">RESOLUTION</span>
            </h1>

            <div className="inline-flex items-center gap-2 bg-yellow-500/10 border border-yellow-500/20 px-4 py-1.5 rounded-full text-[10px] font-black text-yellow-500 uppercase tracking-widest mb-8">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4">
              <Link 
                ...
                className="btn-pill btn-gold px-12 py-4 text-sm font-black flex items-center gap-2 w-full md:w-auto"
              >
          ...
          <div className="mt-8 p-6 bg-yellow-500/5 border border-yellow-500/10 rounded-2xl flex gap-4 max-w-2xl mx-auto">
            <Shield size={24} className="text-yellow-500 shrink-0" />
