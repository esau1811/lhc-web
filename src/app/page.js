...
export default function HomePage() {
  ...
  useEffect(() => {
    // Fetch real stats from our server-side API to bypass CORS
    fetch('/api/discord')
      .then(res => res.json())
      .then(data => {
        if (data && data.total) {
          setDiscordStats({
            total: data.total > 1000 ? (data.total / 1000).toFixed(1) + 'K' : data.total.toString(),
      ...
      .catch(err => {
        ...
        setDiscordStats({ total: '1.2K', online: '450' }); // Real fallback
      });
  }, []);
      ...
      <main className="new-layout-container">
          ...
          <div className="hero-content-wrapper">
            <div className="hero-left-col">
              ...
              <p className="hero-new-desc">
                ...
                Optimiza, personaliza y domina con el mejor software de modding del mercado.
              </p>
            ...
            <div className="hero-right-col">
              <div className="premium-box">
                ...
                <p className="premium-box-desc">Desbloquea todo el potencial de LHC</p>
                <ul className="premium-features-list">
                  ...
                  <li><Check size={14} className="check-icon" /> Sin anuncios ni limitaciones</li>
                </ul>
        ...
        <section className="main-grid" id="tools">
          ...
          <aside className="left-sidebar">
            ...
            <a href="https://discord.gg/AS46Hlp2vO" target="_blank" rel="noopener noreferrer" className="discord-join-card" style={{ marginBottom: '20px' }}>
